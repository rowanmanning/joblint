...
module.exports = [
    ...
    // Use of sexualised terms
    {
        ...
        reason: 'Terms like "sexy code" are often used if the person writing a spec doesn\'t know what they are talking about or can\'t articulate what good code is. It can also be an indicator of bro culture.',
        solution: 'Remove these words.',
        level: 'warning',
        increment: {
            culture: 1
    ...
    // Mention of hollow benefits
    {
        ...
        reason: 'Benefits such as "beer fridge" and "pool table" are not bad in themselves, but their appearance in a job spec often disguises the fact that there are few real benefits to working for a company. Be wary of these.',
    ...
    // New starter expectations
    {
        ...
        reason: 'Terms like "hit the ground running" and others can indicate that the person writing a job spec is unaware of the time and effort involved in preparing a new starter for work.',
    ...
    // Use of profanity
    {
        ...
        reason: 'While swearing in the workplace can be OK, you shouldn\'t be using profanity in a job spec – it\'s unprofessional.',
        solution: 'Remove these words.',
        level: 'warning',
        increment: {
            recruiter: 1
    ...
    // Use of "visionary" terminology
    {
        ...
        reason: 'Terms like "blue sky" and "enlightened" often indicate that a non technical person (perhaps a CEO or stakeholder) has been involved in writing the spec. Be down-to-earth, and explain things in plain English.',
