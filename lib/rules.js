...
module.exports = [
    ...
    // Implicit politics
    {
        name: 'Underground politics',
        reason: '',
        solution: 'All groups of humans include some level of politics (or drama). To claim that your organization has none typically means only that employees may not raise their concerns when impacted by those politics.',
        level: 'notice',
        increment: {
            culture: 1
        },
